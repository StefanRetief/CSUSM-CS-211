    ...
    cout << l.deleteRear() << " has been removed" << endl;
    //2 has been removed
    ...
    cout << "##### EXTRA CREDIT: TEST deleteNode **************************************************************" << endl;
    ...
    cout << "##### EXTRA CREDIT: TEST addInOrder**************************************************************" << endl;
    ...
    cout << endl; 
    l2.printAllReverseDLL(); // 0 1 3 5 5 7
    cout << endl;

    l2.addInOrderDescend(0);
    l2.displayAll(); //[7] -> [7] -> [5] -> [5] -> [3] -> [1] -> [0] -> [0] 
    cout << endl; 
    l2.printAllReverseDLL(); // 0 0 1 3 5 5 7
    cout << endl;
